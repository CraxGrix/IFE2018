...
import {rowSpanCount} from './utils.js'
...
export default function updataTable () {
  ...
  // hash join
  let hashString = ""
  for (let value of Object.keys(optionCheckedArr)) {
    hashString = hashString  + optionCheckedArr[value].join("&") + "&"
  }
  //window.location.hash = hashString
  hashString = "#" + hashString
  history.pushState(hashString, null,  hashString)
